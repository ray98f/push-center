...
//        Map<String, String[]> audienceMap = params.getAudience();\
...
//        Map<String, String> extras = params.getExtras();
    ...
    private static void buildIosInfo(JSONObject notification,
        ...
        if (platformList != null && platformList.size() > 0 && platformList.contains(Platform.IOS)) {
    ...
    private static void buildAndroidInfo(JSONObject notification,
                                         List<Platform> platformList, Map<String, Object> appPushParam) {
        if (platformList != null && platformList.size() > 0 && platformList.contains(Platform.ANDROID)) {
