...
public class TencentCloudAPITC3Demo {
    ...
    private final static String SECRET_ID = AesUtils.decrypt("+Gl2vp+To1q8rVTLv0QW0pRdLK7ZQ/HfVjYpSlEpWIw7PGs4iAPH6Jrf3mqZIg1A");
    private final static String SECRET_KEY = AesUtils.decrypt("/uRJfy/fTasb9381zls2FLI4/32Q4WckSslEWFbCvuVu4aAVji2z/bya/ZiYtepA");
