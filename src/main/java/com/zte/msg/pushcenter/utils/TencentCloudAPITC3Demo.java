...
//                .append(" -H \"X-TC-Region: ").append(region).append("\"")
    ...
    public void test() throws Exception {
        String service = "sms";
        String host = "sms.ap-guangzhou.tencentcloudapi.com";
//        String region = "ap-guangzhou";
        String action = "SendSms";
        String version = "2019-07-11";
        String algorithm = "TC3-HMAC-SHA256";
        String timestamp  = "1608876414";
//        String timestamp = String.valueOf(System.currentTimeMillis() / 1000);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        // 注意时区，否则容易出错
        sdf.setTimeZone(TimeZone.getTimeZone("UTC"));
...
//                .append(" -H \"X-TC-Region: ").append(region).append("\"")
        ...
        ResponseEntity<String> exchange = restTemplate.exchange("https://sms.tencentcloudapi.com", HttpMethod.POST, new HttpEntity<>(payload, headers), String.class);
